...
async function main() {
  ...
  const settings = [
    ...
    { key: "PHONE_PRIMARY", value: "[REPLACE WITH ACTUAL BUSINESS PHONE]", group: "CONTACT" },
    { key: "PHONE_SECONDARY", value: "[REPLACE WITH SECONDARY PHONE]", group: "CONTACT" },
    { key: "WHATSAPP_NUMBER", value: "[REPLACE WITH ACTUAL WHATSAPP NUMBER]", group: "CONTACT" },
    { key: "EMAIL_PRIMARY", value: "[REPLACE WITH BUSINESS EMAIL]", group: "CONTACT" },
    { key: "EMAIL_SALES", value: "[REPLACE WITH SALES EMAIL]", group: "CONTACT" },
    { key: "ADDRESS", value: "[REPLACE WITH FACTORY ADDRESS]", group: "CONTACT" },
